...
ESX = nil
local isskinClotheshopOpened = false
...
RegisterNUICallback('updateSkin', function(data)
	...
	if(v == true) then
		...
		TriggerServerEvent('ds_clotheshops:save', torso, torsotext, leg, legtext, shoes, shoestext, accessory, accessorytext, undershirt,undershirttext, torso2, torso2text, prop_hat, prop_hat_text, prop_glasses, prop_glasses_text, prop_earrings, prop_earrings_text, prop_watches, prop_watches_text)
...
function CloseskinClotheshop()
	local ped = PlayerPedId()
	isskinClotheshopOpened = false
	ShowskinClotheshop(false)
...
function ShowskinClotheshop(enable)
local elements    = {}
